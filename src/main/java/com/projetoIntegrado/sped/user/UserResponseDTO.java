...
public record UserResponseDTO(Long id,int addressNumber, String city, String neighbourhood, int postalCode, String state, String street, int cpf, String pass) {
